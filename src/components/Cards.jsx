  ...
  return (
    <div className=" w-full  px-4 py-[90px]">
      <div className=" max-w-[1280px] mx-auto grid lg:grid-cols-3 md:grid-cols-2 place-items-center gap-8">
        {CardsData.map((data) => (
          <div
            className="relative flex justify-center text-center hover:bg-gray-200 px-[100px] py-[50px] duration-300 rounded-lg shadow-xl dark:bg-gray-900 dark:hover:bg-gray-800 hover:scale-105"
            key={data.id}
          >
            <img
            ...
            <div>
              ...
              <p className=" border-t border-gray-300 my-2 p-2">
                {data.title2}
              </p>
              <p className=" border-t border-gray-300 my-2 p-2">
                {data.title3}
